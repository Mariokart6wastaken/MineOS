...
component.eeprom.set([[
	local connection, data, chunk = component.proxy(component.list("internet")()).request("https://raw.githubusercontent.com/Mariokart6wastaken/MineOS/master/Installer/Main.lua"), ""
